		...
		return (
			<form id="serviceEditorForm" data-toggle="validator" role="form" action="" onSubmit={this.handleSubmit}>
				...
				<div className="form-group form-group-sm has-feedback">
					...
					<input type="text" pattern="^[._-\d]*$" className="form-control" id="serviceVersion" ref="serviceVersion" placeholder="0" onChange={this.updateState} value={this.state.formData.serviceVersion} />
					<span className="glyphicon form-control-feedback" aria-hidden="true"></span>
					<div className="help-block with-errors"></div>
				</div>
